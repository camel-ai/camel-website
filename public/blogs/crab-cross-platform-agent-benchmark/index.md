...
subtitle: "Introducing CRAB: A Benchmark for Cross-Platform Multimodal Agents。"
date: "2024-08-09"
author: CAMEL-AI Team
authorprofile: ""
role: ""
description: "Discover CRAB, the groundbreaking framework by CAMEL-AI that empowers agents to operate across multiple devices simultaneously."
seoTitle: "CRAB: Cross-environment Agent Benchmark for Multimodal Language Model Agents"
seoDescription: "Discover CRAB, the groundbreaking framework by CAMEL-AI that empowers agents to operate across multiple devices simultaneously."
keywords:
  - CAMEL-AI
  - CRAB
  - agent benchmark
  ...
  - cross-platform
toc: true
cover: ./assets/6734a675d10b1f5fff3eff11_release20notes20oct.jpg
thumbnail: ./assets/6734a675d10b1f5fff3eff11_release20notes20oct.jpg
featured: false
category: Research
---

> Abstract: Recently, spearheaded by the CAMEL-AI community, a pioneer in open-source multi-agent projects, researchers from institutions such as King Abdullah University of Science and Technology, Oxford University, University of Tokyo, Carnegie Mellon University, Stanford University, and Tsinghua University have developed a cross-platform/environment multimodal agent benchmark framework: CRAB, innovatively enabling agents to operate multiple devices simultaneously.
...
![CRAB Paper](./assets/66b488289750e3484d51bfb8_66b48746d60ac617f7d0651c_crab-title.png)

Paper link: <https://arxiv.org/abs/2407.01511>

The CAMEL-AI framework (<https://github.com/camel-ai>) developed by the CAMEL-AI community is one of the earliest open-source multi-agent projects based on large language models. Therefore, community members are researchers and engineers with rich research and practical experience in the field of agents.

In CRAB, the authors not only designed a cross-platform multi-agent architecture that enables agents to operate multiple devices simultaneously to complete tasks, and introduced two breakthroughs for **autonomous agent frameworks**: the **graph evaluator for agent-based modeling** and **task synthesis**, enabling fine-grained evaluation in **multiagent** workflows. CRAB is not only a brand new benchmark tool but also provides an interaction protocol and its implementation between the environment and agents, which is expected to become an important foundation for agents in practical fields.
...
To try **agent orchestration** immediately, CRAB offers a one-click GCP hard disk image—installs demo environments, **mcp servers**, and dependencies so you can benchmark your **multi agent system in AI** right away. With just one click, all the tedious configurations of virtual machines, deep learning models, Python packages, etc., will be completed automatically, allowing users to immediately engage in important experiments.
...
![](./assets/66b4867007d08181157fa19c_66b4865e391b85dc83d1e240_crab-main-diagram.png)
...
![benchmark of CRAB](./assets/66b488279750e3484d51bf98_66b487bf8fc5037ddd8dfb70_crab-result.png)
...
![](./assets/66b488289750e3484d51bfb5_66b487d9194b4c8dba67be16_crab-compare.png)
...
![Crab Benchmark](./assets/66b488289750e3484d51bfb2_66b487f065cccbb37805a2c6_crab-benchmark-v0.png)
...
![](./assets/66b488289750e3484d51bfa9_66b487fdcbd8dfbde1c70bb0_crab-gdt.png)
...
![](./assets/66b488289750e3484d51bfac_66b4880ee29f91b36b415574_crab-ubuntu-result.png)

**Android single-platform tasks:**

![](./assets/66b488289750e3484d51bfaf_66b488176cb2dddebf3799a1_crab-android-result.png)

**Cross-platform tasks:**

![](./assets/66b488289750e3484d51bfa4_66b48821c9e84a1915a4a6e9_crab-cross-result.png)
